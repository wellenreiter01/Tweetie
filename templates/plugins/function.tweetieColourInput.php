...
/**
 * The tweetieColourInput plugin handles fields carrying a html colour code.
 ...
 */
function smarty_function_tweetieColourInput($params, $view)
{
    return $view->registerPlugin('Tweetie_Form_Plugin_ColourInput', $params);
}
