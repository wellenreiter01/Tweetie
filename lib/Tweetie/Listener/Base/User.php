 ...
 */
class Tweetie_Listener_Base_User
{
    /**
    ...
    public static function delete(Zikula_Event $event)
    {
        ...
        $repo = $entityManager->getRepository('Tweetie_Entity_Twitterparm');
        // delete all twitterparms created by this user
        $repo->deleteCreator($uid);
        // note you could also do: $repo->updateCreator($uid, 2);
        
        // set last editor to admin (2) for all twitterparms updated by this user
