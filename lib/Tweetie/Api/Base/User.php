 ...
 */
class Tweetie_Api_Base_User extends Zikula_AbstractApi
{
    /**
    ...
    public function encodeurl(array $args = array())
    {
        ...
        $routerFacade = new Tweetie_RouterFacade();
        ...
        $modInfo = ModUtil::getInfoFromName('Tweetie');
